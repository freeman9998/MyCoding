...
public class InquiryPageCalculator{	
	public static InquiryListPageDto getPagingInfo(
												int selectPage,
												int rowCountPerPage,
												int pageCountPerPage, 
												int totalRecordCount){
		InquiryListPageDto inquiryListPageDto = new InquiryListPageDto();
...
//	 페이지에 [처음으로] 아이콘 출력여부를 판단하는 메소드
	  ...
	  public static void main(String[] args) {
		  ...
		  */
		  ...
		  InquiryListPageDto resultBean = InquiryPageCalculator.getPagingInfo(selectPage,rowCountPerPage,pageCountPerPage,totalRecordCount);
		  System.out.println("***************페이지정보***************");
