	...
	<div class="site-wrap">
		...
		<%
			if (session.getAttribute("m_no") != null) {
				HashMap hs = (HashMap) request.getAttribute("jumunHistory");
				if (hs != null) {
					Jumun j = (Jumun) hs.get("jumun");
					ArrayList<JumunDetail> jd = (ArrayList<JumunDetail>) hs.get("jumunDetail");
		%>
			...
			<div class="container">
				<div class="col-md-6 col-lg-6 d-lg-flex aos-init aos-animate"
					...
					<div class="text">
						...
						<p>
							<a href="McDelivery_mypage_jumunhistory.do"><%=j.getJ_no()%></a>
						</p>
					</div>
					<div class="col-md-8 col-lg-8 d-lg-flex mb-4 mb-lg-0 pl-4  ">
						<div class="text">
							<h2 class="text-uppercase">&nbsp;</h2>
							<p>
							<a href="McDelivery_mypage_jumunhistory.do"><%=j.getJ_address()%></a>
