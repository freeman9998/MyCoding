...
public class JumunListPageDto {
	private ArrayList<JumunList> list; 		// 리스트 데이터 콜렉션
	...
	public JumunListPageDto() {
	}

	public JumunListPageDto(ArrayList<JumunList> list, int startPageNo, int endPageNo,
	...
	public ArrayList<JumunList> getList() {
		return list;
	}

	public void setList(ArrayList<JumunList> list) {
		this.list = list;
	}
