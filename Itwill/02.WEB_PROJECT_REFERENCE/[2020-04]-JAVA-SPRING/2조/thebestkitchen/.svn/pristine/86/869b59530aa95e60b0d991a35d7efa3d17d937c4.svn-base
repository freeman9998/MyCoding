...
function boardList() {
	f.action = "board_product_list.jsp?pageno="+<%=pageno%>;
	f.submit();
}
</script>
</head>
		...
		<div id="wrapper">
			...
			<div id="content">
				<table border=0 cellpadding=0 cellspacing=0>
					<tr>
						<td><br />
							<table style="padding-left: 10px" border=2 cellpadding=1
								cellspacing=0>
								<tr>
									<td bgcolor="f4f4f4" height="22">&nbsp;&nbsp; <b> 상품문의 </b>
									</td>
								</tr>
							</table> <br> 
							<form name="f" method="post">
								...
								<table border="0" cellpadding="0" cellspacing="1" width="590"
									...
									<tr>
										...
										<input type="hidden" value="Q" name="b_type">
