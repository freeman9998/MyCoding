package thebestkitchen.mypage.inquiryutil;
...
public class InquiryListPageDto {
	private ArrayList<ProductInquiry> list; 		// 리스트 데이터 콜렉션
	...
	public InquiryListPageDto() {
	}

	public InquiryListPageDto(ArrayList<ProductInquiry> list, int startPageNo, int endPageNo,
	...
	public ArrayList<ProductInquiry> getList() {
		return list;
	}

	public void setList(ArrayList<ProductInquiry> list) {
		this.list = list;
	}
