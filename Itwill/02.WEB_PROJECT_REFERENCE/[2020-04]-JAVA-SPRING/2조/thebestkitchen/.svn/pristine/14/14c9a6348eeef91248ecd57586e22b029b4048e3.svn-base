...
public class HugiListPageDto {
	private ArrayList<ProductHugi> list; 		// 리스트 데이터 콜렉션
	...
	public HugiListPageDto() {
	}

	public HugiListPageDto(ArrayList<ProductHugi> list, int startPageNo, int endPageNo,
	...
	public ArrayList<ProductHugi> getList() {
		return list;
	}

	public void setList(ArrayList<ProductHugi> list) {
		this.list = list;
	}
