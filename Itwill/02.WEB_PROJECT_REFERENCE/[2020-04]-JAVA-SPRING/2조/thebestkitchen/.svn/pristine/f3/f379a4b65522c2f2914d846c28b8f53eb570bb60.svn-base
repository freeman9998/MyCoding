...
<html>
	<head>
		...
		function Edit(){
			...
			f.action = "manager_member_update_action.jsp";
			f.submit();
		}
		function Delete(){
	...
	<body style="margin: 100px 0;">
		<h1 style="text-align:center;">회원정보관리</h1>
		         ...
		         <div class="table-responsive">
		            <table id="mytable" class="table table-bordred table-striped">
		               ...
		               <tbody>
                        ...
                        <button class="btn btn-primary btn-xs" type="submit" data-title="Edit" data-toggle="modal" data-target="#edit" onclick="Edit()"><span class="glyphicon glyphicon-pencil" style="width:500px; height:50px;">UPDATE</span></button>
                        <button class="btn btn-danger btn-xs" type="submit" data-title="Delete" data-toggle="modal" data-target="#delete" onclick="Delete()"><span class="glyphicon glyphicon-trash" style="width:500px; height:50px;">DELETE</span></button>
		      </div>
		   </div>
		</div>
		</form>
