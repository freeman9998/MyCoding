...
<script type="text/javascript">
	function boardReplayCreate() {
		...
		f.action = "board_review_reply_write_action.jsp";
		f.method='POST';
		f.submit();
	}

	function boardList() {
		f.action = "board_review_view.jsp?boardno=<%=board.getB_no() %>&pageno=<%=pageno%>";
		f.submit();
	}
</script>
</head>
					...
					<tr>
						<td><br />
							...
							<form name="f" method="post">
		        				...
		        				<input type="hidden" name="typeQ" value="Q"/>
		        				<input type="hidden" name="typeR" value="R"/>
								...
								<table border="0" cellpadding="0" cellspacing="1" width="590"
									...
									<tr>
										...
										<td width=490 bgcolor="ffffff" style="padding-left: 10px" align="left">
											<input value="[RE]<%=board.getB_title()%>"  type="text" style="width: 150"
											name="title">
										</td>
									</tr>
									<tr>
										...
										<td width=490 bgcolor="ffffff" style="padding-left: 10px" align="left">
											<input value="<%=(String)session.getAttribute("sMemberId")%>"type="text" style="width: 150"
											name="writer">
										</td>
									</tr>
									<tr>
										...
										<td width=490 bgcolor="ffffff" style="padding-left: 10px" align="left">
											<textarea name="content" class="textarea" style="width: 350px" rows="14">>><%=board.getB_content().replace("\n",">>").trim()%></textarea>
										</td>
									</tr>
							...
							<table width=590 border=0 cellpadding=0 cellspacing=0>
								<tr>
									<td align=center>
									<input type="button" value="게시판 답글 쓰기"
										onClick="boardReplayCreate()"> &nbsp; 
