...
public class HugiPageCalculator{	
	public static HugiListPageDto getPagingInfo(
		...
		HugiListPageDto hugiListPageDto = new HugiListPageDto();
		...
		hugiListPageDto.setStartPageNo(startPageNo);
		hugiListPageDto.setEndPageNo(endPageNo);
		hugiListPageDto.setSelectPageNo(selectPageNo);
		hugiListPageDto.setTotalRecordCount(totalRecordCount);
		hugiListPageDto.setTotalPageCountCount(totalPageCount);
		hugiListPageDto.setPreviousGroupStartPageNo(previousGroupStartPageNo);
		hugiListPageDto.setNextGroupStartPageNo(nextGroupStartPageNo);
		hugiListPageDto.setStartRowNum(startRow);
		hugiListPageDto.setEndRowNum(endRow);
		...
		hugiListPageDto.setShowPreviousGroup(isShowPreviousMoreIcon(groupNo,totalPageCount));
		hugiListPageDto.setShowNextGroup(isShowNextMoreIcon(endPageNo,totalPageCount));
		hugiListPageDto.setShowFirst(isShowFirstIcon(groupNo,totalPageCount));
		hugiListPageDto.setShowLast(isShowLastIcon(endPageNo,totalPageCount));
		...
		System.out.println("03.요청페이지번호\t\t:"+hugiListPageDto.getSelectPageNo());
		System.out.println("04.전체게시물수\t\t\t:"+hugiListPageDto.getTotalRecordCount());
		System.out.println("05.전체페이지수\t\t\t:"+hugiListPageDto.getTotalPageCount());
		System.out.println("06.요청페이지그룹번호\t\t:"+groupNo);
		System.out.println("07.요청페이지그룹시작번호\t:"+hugiListPageDto.getStartPageNo());
		System.out.println("08.요청페이지그룹끝번호\t\t:"+hugiListPageDto.getEndPageNo());
		System.out.println("09.이전페이지그룹시작번호\t:"+hugiListPageDto.getPreviousGroupStartPageNo());
		System.out.println("10.다음페이지그룹시작번호\t:"+hugiListPageDto.getNextGroupStartPageNo());
		System.out.println("11.DB에서select할게시물시작번호 :"+hugiListPageDto.getStartRowNum());
		System.out.println("12.DB에서select할게시물끝번호   :"+hugiListPageDto.getEndRowNum());
		System.out.println("13.이전페이지그룹보여주기◀\t:"+hugiListPageDto.isShowPreviousGroup());
		System.out.println("14.다음페이지그룹보여주기▶\t:"+hugiListPageDto.isShowNextGroup()); 		
		System.out.println("15.처음페이지보여주기◀◀  \t:"+hugiListPageDto.isShowFirst());
		System.out.println("16.마지막페이지보여주기▶▶\t:"+hugiListPageDto.isShowLast()); 		
		System.out.println("**************************************");
		
		return hugiListPageDto;				
	}
