...
<%
	...
	if (sp_no == null || sp_no.equals("")) {
		response.sendRedirect("jumun_direct_view.jsp");
		return;
	}  
	   
	ProductService productService = new ProductService();
	HashMap productMap = productService.findOneProductWithGenre(p_no);
...
<script type="text/javascript">
		function jumunDirect() {
			...
			f.action = 'jumun_direct_action.jsp';
			f.method = 'POST';
			f.submit();
		}
		function backToShop() {
				...
				<tr>
					<td><br />
							...
							<table align=center border=1 width=80% cellspacing=0
								...
								<tr>
								 ...
								 <TR>
								  ...
								  <TD colspan=2 bgcolor=#eeeeee>
								   <INPUT type=text name=cardNumber size=30>
								  </TD>
								  </tr>
								  <tr>
								  <TH width=30% bgcolor=#F8BO3A>
						...
						<table border="-1" cellpadding="0" cellspacing="1" width="590">
							<tr>
								<td align=center>
								    <input type="button" value="구매" onClick="jumunDirect()"> &nbsp; 
									<input type="button" value="취소" onClick="backToShop()"></td>
							</tr>
						</table></td>
				</tr>
			</table>
