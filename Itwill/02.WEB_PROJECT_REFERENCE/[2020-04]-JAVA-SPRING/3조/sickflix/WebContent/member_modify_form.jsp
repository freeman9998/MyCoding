...
<%
	...
	Member member=null;
	try{
	   member =  memberService.findMember(sM_id);
	}catch(Exception e){
					...
					<tr>
						<td>
							...
							<table style="padding-left: 10px" border=0 cellpadding=0
								cellspacing=0>
								<tr>
									<td bgcolor="f4f4f4" height="22">&nbsp;&nbsp;<b>회원정보수정</b></td>
								</tr>
							</table> <!-- update Form  -->
							<form name="f" method="post">
								<table border="0" cellpadding="0" cellspacing="1" width="590"
									...
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">비밀번호 재확인</td>
										<td width=490 bgcolor="ffffff" style="padding-left: 10px"
											align="left"><input type="password" style="width: 150px"
									...
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">이메일 주소
											</td>
							...
							<table width=590 border=0 cellpadding=0 cellspacing=0>
								<tr>
									<td align=center><input type="button" value="수정"
										onClick="memberModify()"> &nbsp; <input type="button"
