				...
				<tr>
					<td><br />
						<table style="padding-left: 10px" border=0 cellpadding=0
							cellspacing=0>
							<tr>
								<td bgcolor="f4f4f4" height="22">&nbsp;&nbsp;<b>장바구니 보기</b></td>
							</tr>
						</table> <!--form-->
						<form name="f" method="post">
							<table align=center border=1 width=80% cellspacing=0
								...
								<tr>
									<td width=55 height=25 bgcolor=#4682b4 align=center class=t1><font
										color=#FFFFFF>영화</font></td>
										
										<!-- 체크박스로 삭제 또는 주문할 영화 체크 -->

									<td width=300 height=25 bgcolor=#4682b4 align=center class=t1><font
								...
								<tr>
									...
									<td width=15 height=26 bgcolor=#4682b4 align=center class=t1>
										<img src="image/<%=cartProduct.getP_image()%>" width="15" height="26" border="0"></td>
									...
									<td width=50 height=26 align=center class=t1>
										<a href="cart_delete_action.jsp?c_item_no=<%=cartItem.getC_item_no()%>" class=m1>삭제</a></td>
									</tr>
								<!-- cart item end -->
								<%
									}
								...
								<tr>
									<td width=640 colspan=4 height=26 class=t1>
										<p align=right>
											<font color=#FF0000>상품 금액 : <%=df.format(tot)%> 원
											</font>
										</p>
									</td>
								</tr>
							</table>
							<input type="hidden" name=tot value="<%=df.format(tot)%>">
						</form> <br />
						<table border="0" cellpadding="0" cellspacing="1" width="590">
							<tr>
								<td align=center>&nbsp;&nbsp;
									<!-- 체크한 상품만 삭제하는 버튼 -->
									<a href=cart_delete_all_action.jsp class=m1>장바구니 비우기</a>&nbsp;&nbsp;
									<a href=product_list.jsp class=m1>쇼핑 계속하기</a>&nbsp;&nbsp;
									<a href="jumun_cart_view.jsp" class=m1>구매하기</a>
								</td>
							</tr>
						</table></td>
				</tr>
