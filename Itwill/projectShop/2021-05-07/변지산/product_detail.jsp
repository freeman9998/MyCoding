...
<%
	...
	Product product = productService.productDetatil(Integer.parseInt(p_noStr));
%> 
							...
							<table style="margin-left: 10px" border=0 width=80% height=376
								...
								<tr width=100%>
									...
									<td width=30% height=200 class=t1>
										<ol type="disc">
											<li><b>제품 : <%=product.getP_name() %>&nbsp;&nbsp;&nbsp;</b></li>
											<li><font color=#FF0000>가격 : <%=product.getP_price() %>원 &nbsp;&nbsp;&nbsp;</font></li>
