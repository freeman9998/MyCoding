...
<%@page import="com.itwill.shop.product.ProductDaoImpl"%>
								...
								<table width="100%" align="center" border="1" cellspacing="0"
									...
									<tr>
										...
										<td align="center" width="25%"><a
											href="product_detail.do?p_no=<%=product.getP_no()%>"><img
												src="image/<%=product.getP_image()%>" border="0" width="200" height="200"></a><br /> <br /> <b><%=product.getP_name() %></b><br>
											<font color="#FF0000">가격:<%=product.getP_price() %></font></td>
										<!--상품 끝 -->
										<%} %>
