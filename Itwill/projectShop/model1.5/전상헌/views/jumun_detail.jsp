...
<%@page import="com.itwill.shop.jumun.JumunServiceImpl"%>
<%@page import="com.itwill.shop.jumunDetail.JumunDetail"%>
<%@page import="java.util.List"%>
<%@page import="com.itwill.shop.jumunDetail.jumunDetailServiceImpl"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%> 
 <% 
 	Jumun jumun=(Jumun)request.getAttribute("jumun");
 	List<JumunDetail> jumunDetailList=(List<JumunDetail>)request.getAttribute("jumunDetailList");
				...
				<table border=0 cellpadding=0 cellspacing=0>
					<tr>
						<td><br />
							...
							<form name="f" method="post" action="jumun_delete_action.do">
								...
								<table align=center  width=80% cellspacing=0
									...
									<tr>
										...
										<%=new DecimalFormat("##.###").format(jumunDetail.getProduct().getP_price()*jumunDetail.getJd_qty()) %>
										</td>
									...
									<tr>
										<td width=640 colspan=4 height=26 class=t1>
											<p align=right>
												<font color=#FF0000>총 주문 금액 :<%=new DecimalFormat("##.###").format(jumun.getJ_price()) %> 원
												</font>
											</p>
										</td>
									</tr>
