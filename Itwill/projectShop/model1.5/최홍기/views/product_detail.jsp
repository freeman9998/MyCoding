...
<script type="text/javascript">
	...
	function jumun_create_form() {
		if (<%=!isLogin %>) {
			...
			document.buyFrm.action = 'jumun_create_form.do';
							...
							<table style="margin-left: 10px" border=0 width=80% height=376
								...
								<tr width=100%>
									<td width=30% height=200 align=center class=t1>
										<form method="post" action="cart_add_action.do">
									...
									<td width=30% height=200 class=t1>
										<ol type="disc">
											...
											<li><font color=#FF0000>가격 : <%=new DecimalFormat("#,##0").format(product.getP_price()) %>원&nbsp;&nbsp;&nbsp;</font></li>
