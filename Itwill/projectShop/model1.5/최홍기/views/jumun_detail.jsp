							...
							<form name="f" method="post" action="jumun_delete_action.do">
							    ...
							    <table align=center width=80% cellspacing=0
									...
									<tr>
										...
										<td width=166 height=26 align=center class=t1><%=jumun.getUser().getUserId() %></td>
								...
								<table align=center  width=80% cellspacing=0
									...
									for(JumunDetail jumunDetail:jumunDetailList){
										tot += 	jumunDetail.getJd_qty() * jumunDetail.getProduct().getP_price();
									%>
									<!-- cart item start -->
									<tr>
										<td width=290 height=26 align=center class=t1>
										<a href='product_detail.jsp?p_no=<%=jumunDetail.getProduct().getP_no() %>'><%=jumunDetail.getProduct().getP_name() %></a>
										</td>
										...
										<%=new DecimalFormat("##,##0").format(jumunDetail.getJd_qty() * jumunDetail.getProduct().getP_price()) %>
										</td>
									...
									<tr>
										<td width=640 colspan=4 height=26 class=t1>
											<p align=right>
												<font color=#FF0000>총 주문 금액 : <%=new DecimalFormat("##,##0").format(tot) %> 원
												</font>
											</p>
										</td>
									</tr>
