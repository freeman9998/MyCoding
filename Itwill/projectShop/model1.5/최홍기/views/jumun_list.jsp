...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	List<Jumun> jumunList = (List<Jumun>) request.getAttribute("jumunList");
%>
					...
					<tr>
						<td><br />
							...
							<form name="f" method="post">
								<table align=center border=1 width=80% cellspacing=0
									...
									<tr>
										...
										<td width=112 height=26 align=center class=t1><%=jumun.getJ_date().toLocaleString().substring(0, 10) %></td>
										<td width=136 height=26 align=center class=t1><%=new DecimalFormat("##,##0").format(jumun.getJ_price()) %></td>
										<td width=80 height=26 align=center class=t1><a
											href="jumun_detail.do?j_no=<%=jumun.getJ_no() %>" class=m1>주문상세</a></td>
									</tr>
									<!-- jumun item end -->
									<%} %>
							...
							<table border="0" cellpadding="0" cellspacing="1" width="590">
								<tr>
									<td align=center>&nbsp;&nbsp;<a href=product_list.do
										class=m1>계속 구경하기</a> 
