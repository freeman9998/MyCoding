						...
						<td><br />
							...
							<table  align=center border=1 width=80% cellspacing=0
									...
									<tr>
										...
										<td width=250 height=26 align=center class=t1><a href='product_detail.jsp?p_no=1'><%=cart.getProduct().getP_name() %></a></td>
										<td width=112 height=26 align=center class=t1><%=cart.getCart_qty() %></td>
										<td width=166 height=26 align=center class=t1><%=cart.getCart_qty()*cart.getProduct().getP_price() %></td>
