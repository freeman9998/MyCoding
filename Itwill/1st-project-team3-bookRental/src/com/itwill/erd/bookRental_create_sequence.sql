...
drop table reserv_book;

--시퀀스 삭제
DROP SEQUENCE reserv_book_seq;
DROP SEQUENCE book_seq;
DROP SEQUENCE borrow_book_seq;

--시퀀스 생성 
create sequence reserv_book_seq start with 1 nocycle nocache;
...
create table bookmember(
    ...
    member_phone_1 varchar2(10) not null,
    member_phone_2 varchar2(10) not null,
    member_phone_3 varchar2(10) not null,
    member_email_1 varchar2(50) unique,
...
create table borrow_book(
     ...
     borrow_return date default sysdate+7,
...
create table reserv_book(
    ...
    reserv_count number(10) not null,
     constraint reserv_book_member_id_fk foreign key(member_id)  references bookmember(member_id),
     constraint borrow_book_book_no_fk foreign key(book_no)  references book(book_no)
);
