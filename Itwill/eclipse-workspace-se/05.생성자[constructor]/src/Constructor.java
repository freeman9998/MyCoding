/*
접근제어자 반환타입 이름(매개변수1,매개변수2){
}
접근제어자  클래스이름(매개변수1,매개변수2){
}  
...
public class Constructor {
	...
	public Constructor() {
		/*
		 * 생성자 : 객체생성후 최초로단한번 호출되는 메쏘드
		 */
		System.out.println("Constructor() 기본생성자메쏘드 실행 this주소-->"+this);
		this.member1=100;
		this.member2=200;
	}
	public Constructor(int member1) {
		System.out.println("Constructor(int member1) 생성자메쏘드실행");
		this.member1=member1;
		this.member2=200;
	}
	public Constructor(int member1,int member2) {
		System.out.println("Constructor(int member1,int member2) 생성자메쏘드실행");
		this.member1=member1;
