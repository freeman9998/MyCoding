...
public class MIMETypeImageResponseServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String contextImageRealPath = siteContext.getRealPath("/images/album.jpg");
		System.out.println(contextImageRealPath);
		/*
		C:\JAVA_BACKEND\eclipse-workspace-ee\.metadata\.plugins\org.eclipse.wst.server.core\tmp2\wtpwebapps\servletSite
		 */
