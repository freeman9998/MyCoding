...
public class StudentDaoMain {
	...
	public static void main(String[] args) {
		...
		HashMap studentParmaMap=new HashMap();
		studentParmaMap.put("student",new Student(1, "유노유노", "you@no.co.kr",new Date()));
		System.out.println("### "+studentDao.updateStudentParamMap(studentParmaMap));
		*/
		System.out.println("---------findStudentsThreeParamMap(parameter Map)----");
		HashMap threeStudentMap=new HashMap();
		threeStudentMap.put("first", new Student(1,"KIM","imail1",new Date()));
		threeStudentMap.put("second", new Student(2,"SIM","email1",new Date()));
		threeStudentMap.put("third", new Student(3,"TIM","smail1",new Date()));
