...
create table javabackend0.dept3( 
    deptno number(2),
    dname varchar2(50),
    loc varchar2(50)
);
...
values(4,'오늘은 수요일 입니다.','좀덜 기뻐요',to_date('2022/01/01','YYYY/MM/DD'),999,'T');
...
--ORA-12899: value too large for column "JAVABACKEND0"."DATA_TYPE"."NAME" (actual: 21, maximum: 20)
insert into data_type values(1111,'김경미는누구게','F',167.55);
--ORA-12899: value too large for column "JAVABACKEND0"."DATA_TYPE"."GENDER" (actual: 6, maximum: 1)
insert into data_type values(1111,'김경미','FEMALE',167.55);
--소수점이하자리수는 반올림
insert into data_type values(1111,'김경미','F',167.55555555555);
--ORA-01438: value larger than specified precision allowed for this column
