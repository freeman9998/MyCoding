    ...
    ==========================================-->
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
						    ...
						    <span class="wtnbreadcrumbs"><a href="index.jsp">Home</a> <span class="separator">��</span> <span class="actual">Purchase Confirmation</span></span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container container-boxed">
				<div class="entry-content">
					...
					<tbody>
					<tr>
						<td class="edd_receipt_payment_status">
							<strong>Payment Status:</strong>
						</td>
						<td class="edd_receipt_payment_status complete">
							Complete
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td>
							...
							<div class="edd_purchase_receipt_product_notes">
								<p>
									here are some download notes to your buyer (optional)
								</p>
							</div>
							<ul class="edd_purchase_receipt_files">
								<li class="edd_download_file">
								<a href="#" class="edd_download_file_link">Lemar Theme - Single License</a>
								</li>
								<li class="edd_download_file">
								<a href="#" class="edd_download_file_link">Lemar Theme - Multiple License</a>
								</li>
							</ul>
						</td>
						<td>
