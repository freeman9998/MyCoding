				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
						    ...
						    <span class="wtnbreadcrumbs"><a href="index.jsp">Home</a> <span class="separator">��</span> <span class="actual">Purchase History</span></span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="entry-content">
				...
				<tr class="edd_purchase_row">
					...
					<td class="edd_purchase_amount">
						<span class="edd_purchase_amount">$18.00</span>
					</td>
					<td class="edd_purchase_details">
						<a href="purchase-confirmation.jsp">View Details and Downloads</a>
					</td>
				</tr>
				<tr class="edd_purchase_row">
					<td class="edd_purchase_id">
					...
					<td class="edd_purchase_amount">
						<span class="edd_purchase_amount">$5.00</span>
					</td>
					<td class="edd_purchase_details">
						<a href="purchase-confirmation.jsp">View Details and Downloads</a>
					</td>
				...
				<tr class="edd_purchase_row">
					...
					<td class="edd_purchase_amount">
						<span class="edd_purchase_amount">$0.00</span>
					</td>
					<td class="edd_purchase_details">
						<a href="purchase-confirmation.jsp">View Details and Downloads</a>
					</td>
				...
				<tr class="edd_purchase_row">
					...
					<td class="edd_purchase_amount">
						<span class="edd_purchase_amount">$26.00</span>
					</td>
					<td class="edd_purchase_details">
						<a href="purchase-confirmation.jsp">View Details and Downloads</a>
					</td>
