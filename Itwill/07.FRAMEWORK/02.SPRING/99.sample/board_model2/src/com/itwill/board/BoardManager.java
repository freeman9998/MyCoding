...
public class BoardManager {
	...
	public int create(Board board) throws SQLException,Exception{
	...
	public ListResultBean findBoardList(ListPageConfigBean pageConfig)
		...
		listResultBean = PageCounter.getPagingInfo(
					Integer.parseInt(pageConfig.getSelectPage()),//요청페이지 8
					pageConfig.getRowCount(),//한화면당보여지는행의수 10 
					pageConfig.getPagingCount(),//page index숫자 5
					recordCount//전체레코드수 598
					);
