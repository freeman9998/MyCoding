...
public class PageCalculator{	
	public static ReviewListPageDto getPagingInfo(
												int selectPage,
												int rowCountPerPage,
												int pageCountPerPage, 
												int totalRecordCount){
		ReviewListPageDto reviewListPageDto = new ReviewListPageDto();
		...
		reviewListPageDto.setStartPageNo(startPageNo);
		reviewListPageDto.setEndPageNo(endPageNo);
		reviewListPageDto.setSelectPageNo(selectPageNo);
		reviewListPageDto.setTotalRecordCount(totalRecordCount);
		reviewListPageDto.setTotalPageCountCount(totalPageCount);
		reviewListPageDto.setPreviousGroupStartPageNo(previousGroupStartPageNo);
		reviewListPageDto.setNextGroupStartPageNo(nextGroupStartPageNo);
		reviewListPageDto.setStartRowNum(startRow);
		reviewListPageDto.setEndRowNum(endRow);
		...
		reviewListPageDto.setShowPreviousGroup(isShowPreviousMoreIcon(groupNo,totalPageCount));
		reviewListPageDto.setShowNextGroup(isShowNextMoreIcon(endPageNo,totalPageCount));
		reviewListPageDto.setShowFirst(isShowFirstIcon(groupNo,totalPageCount));
		reviewListPageDto.setShowLast(isShowLastIcon(endPageNo,totalPageCount));
		...
		System.out.println("03.요청페이지번호\t\t:"+reviewListPageDto.getSelectPageNo());
		System.out.println("04.전체게시물수\t\t\t:"+reviewListPageDto.getTotalRecordCount());
		System.out.println("05.전체페이지수\t\t\t:"+reviewListPageDto.getTotalPageCount());
		System.out.println("06.요청페이지그룹번호\t\t:"+groupNo);
		System.out.println("07.요청페이지그룹시작번호\t:"+reviewListPageDto.getStartPageNo());
		System.out.println("08.요청페이지그룹끝번호\t\t:"+reviewListPageDto.getEndPageNo());
		System.out.println("09.이전페이지그룹시작번호\t:"+reviewListPageDto.getPreviousGroupStartPageNo());
		System.out.println("10.다음페이지그룹시작번호\t:"+reviewListPageDto.getNextGroupStartPageNo());
		System.out.println("11.DB에서select할게시물시작번호 :"+reviewListPageDto.getStartRowNum());
		System.out.println("12.DB에서select할게시물끝번호   :"+reviewListPageDto.getEndRowNum());
		System.out.println("13.이전페이지그룹보여주기◀\t:"+reviewListPageDto.isShowPreviousGroup());
		System.out.println("14.다음페이지그룹보여주기▶\t:"+reviewListPageDto.isShowNextGroup()); 		
		System.out.println("15.처음페이지보여주기◀◀\t:"+reviewListPageDto.isShowFirst());
		System.out.println("16.마지막페이지보여주기▶▶\t:"+reviewListPageDto.isShowLast()); 		
		System.out.println("**************************************");
		
		return reviewListPageDto;				
	}
...
//	 페이지에 [처음으로] 아이콘 출력여부를 판단하는 메소드
	  ...
	  public static void main(String[] args) {
		  ...
		  */
		  ...
		  ReviewListPageDto resultBean = PageCalculator.getPagingInfo(selectPage,rowCountPerPage,pageCountPerPage,totalRecordCount);
		  System.out.println("***************페이지정보***************");
