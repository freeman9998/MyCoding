...
public class AcademyMemberService {
	public static final int MEMBER_GANGSA = 1;
	public static final int MEMBER_STAFF = 2;
	public static final int MEMBER_STUDENT = 3;
    ...
    */
	...
	/*
	 * 2-1.번호 1번 AcademyMember객체 참조변수반환해줘
	 */
	...
	*/
	...
	4.AcademyMember 중에서 영업부서인 AcademyStaff객체들 배열참조변수반환해줘
	4.AcademyMember 중에서 OS과목인 AcademyGangsa객체들 배열참조변수반환해줘
	*/
	...
	5.AcademyMember 중에서 영업부서인 AcademyStaff객체들 배열참조변수반환해줘
	5.AcademyMember 중에서 OS과목인 AcademyGangsa객체들 배열참조변수반환해줘
	*/
	public AcademyMember[] findAcademyMembers(AcademyMember searchMember) {
		...
		if (searchMember instanceof AcademyStudent) {
			...
			int count=0;
			for (AcademyMember member : staffs) {
				AcademyStaff staff = (AcademyStaff)member;
				AcademyStaff searchStaff = (AcademyStaff)searchMember;
				if(staff.getDepart().equals(searchStaff.getDepart())) {
					count++;
				}
			}
			findMembers = new AcademyMember[count];
			...
			AcademyMember[] gangas = this.findAcademyMembersByType(MEMBER_GANGSA);
			int count=0;
			for (AcademyMember member : gangas) {
