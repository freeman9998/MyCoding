...
public class AcademyMemberServiceMain {
	...
	public static void main(String[] args) {
		...
		AcademyMember[] findAcademyStudentByBan = academyMemberService.findAcademyStudentByBan("자바");
		System.out.println("4.AcademyMember 중에서 영업부서인 AcademyStaff  객체들 배열참조변수반환해줘");
		AcademyMember[] findAcademyStaffByDepart = academyMemberService.findAcademyStaffByDepart("영업");
		System.out.println("4.AcademyMember 중에서 OS과목인 AcademyGangsa 객체들 배열참조변수반환해줘");
		AcademyMember[] findAcademyGangsaBySubject = academyMemberService.findAcademyGangsaBySubject("OS");
		System.out.println("---------------------------------------------");
		System.out.println("5.AcademyMember 중에서 자바반인  AcademyStudent객체들 배열참조변수반환해줘");
		AcademyMember[] findAcademyMembers = academyMemberService.findAcademyMembers(new AcademyStudent(0, null, "자바"));
		...
		System.out.println("5.AcademyMember 중에서 OS과목인 AcademyGangsa 객체들 배열참조변수반환해줘");
