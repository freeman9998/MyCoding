...
public class AcademyMemberServiceMain {
	...
	public static void main(String[] args) {
		...
		AcademyMember[] findByStudentBan = academyMemberService.findAcademyStudentByBan("자바");
		System.out.println("4.AcademyMember 중에서 영업부서인 AcademyStaff  객체들 배열참조변수반환해줘");
		AcademyMember[] finByStudentDepart = academyMemberService.findAcademyStaffByDepart("영업");					
		System.out.println("4.AcademyMember 중에서 자바과목인 AcademyGangsa 객체들 배열참조변수반환해줘");
		AcademyMember[] finByStudentsubject = academyMemberService.findAcademyGangsaBySubject("DB");
