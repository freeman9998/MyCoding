...
public class StudentArrayMain {
	...
	public static void main(String[] args) {
		 ...
		 */
		Student[] students = { 
				new Student(1, "KIM", 89, 93, 94, 1), 
				new Student(2, "HIM", 88, 77, 98, 1),
				new Student(3, "AIM", 65, 87, 99, 1), 
				new Student(4, "BIM", 75, 97, 60, 1), 
				new Student(5, "XIM", 85, 98, 90, 1),
				new Student(6, "TIM", 95, 88, 77, 1), 
				new Student(7, "ZIM", 99, 93, 95, 1), 
				new Student(8, "LIM", 83, 80, 99, 1),
				new Student(9, "QIM", 73, 90, 80, 1),
		};
		...
		for (int i = 1; i < students.length; i++) {
			for (int j = 0; j < students.length-i; j++) {
				if(students[j].getGrade() < students[j+1].getGrade()) {
					Student tempGrade = students[j];
					students[j] = students[j+1];
					students[j+1] = tempGrade;				
				}
			}
		}
		for (int i = 0; i < students.length; i++) {
