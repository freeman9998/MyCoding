...
public class AccountServiceArrayListMain {
	...
	public static void main(String[] args) {
		...
		int totBalance = accountServiceArrayList.totalBalance();
		...
		System.out.println();
		System.out.println("7.AccountServiceArrayList야1111번계좌 50000원 출금해줘");
		accountServiceArrayList.withdraw(1111, 50000);
		System.out.println();
		/*
		...
		accountServiceArrayList.deposit(6666, 4000);
		System.out.println(accountServiceArrayList.findByNo(6666));
		System.out.println();
