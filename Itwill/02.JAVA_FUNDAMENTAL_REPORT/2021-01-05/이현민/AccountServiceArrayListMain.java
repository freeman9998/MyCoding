...
public class AccountServiceArrayListMain {
	...
	public static void main(String[] args) {
		...
		boolean checkNo = accountServiceArrayList.addAccount(addAccount);
		...
		System.out.println(accountServiceArrayList.findByNo(5555));
		...
		System.out.println("입금 전: "+accountServiceArrayList.findByNo(6666));
		accountServiceArrayList.ipGum(6666, 4000);
		System.out.println("입금 후: "+accountServiceArrayList.findByNo(6666));		
		System.out.println("8.AccountServiceArrayList야1111번계좌 50000원 출금해줘");
		System.out.println("출금 전: "+accountServiceArrayList.findByNo(1111));
		accountServiceArrayList.chulGum(1111, 50000);
		System.out.println("출금 후: "+accountServiceArrayList.findByNo(1111));
