...
public class Account {
	...
	//계좌정보출력메쏘드
	public void print() {
		char firstName = owner.toUpperCase().charAt(0);
		String lastName = owner.replace(owner.substring(0), "****");
		String printOwner = firstName+lastName;
		System.out.printf("%d %3s %2d %4.1f %n",no,printOwner,balance,iyul);
		/*
		 1.첫글자 대문자
		 2.5자리로출력
		 3.첫글자이외에는****(4개)
