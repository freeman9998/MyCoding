...
public class AccountServiceArrayListMain {
	...
	public static void main(String[] args) {
		...
		Account addAccount = new Account(1000, "서강준", 55000, 0.5);
		
		boolean b = accountServiceArrayList.addAccount(addAccount);
		...
		ArrayList<Account> findOwners = accountServiceArrayList.findByName("AIM");
		System.out.println(" 반환계좌수:" + findOwners.size());
		
		System.out.println("9.AccountServiceArrayList야1111번계좌 5000원 출금해줘");
		...
		ArrayList<Account> findVips = accountServiceArrayList.findByVip(70000);
		System.out.println(" 반환계좌수:" + findVips.size());
