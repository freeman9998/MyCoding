...
public class StudentScorePrintSwitch {
	...
	public static void main(String[] args) {
		 ...
		 */
		int no1,no2,kor1,kor2,eng1,eng2,math1,math2,tot1,tot2;
...
System.out.println("----------------------------------------------------");
System.out.printf("%2d  %4s  %d  %4d  %4d  %4d  %6.1f  %c  %3d%n",no1, name1, kor1, eng1, math1, tot1, avg1, grade1, rank1);
System.out.printf("%2d  %4s  %d  %4d  %4d  %4d  %6.1f  %c  %3d%n",no2, name2, kor2, eng2, math2, tot2, avg2, grade2, rank2);
System.out.println("----------------------------------------------------");
	}
