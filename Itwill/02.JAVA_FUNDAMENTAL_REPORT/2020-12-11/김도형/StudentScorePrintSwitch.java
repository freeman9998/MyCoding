public class StudentScorePrintSwitch{
	public static void main(String[] args){
		...
		if(kor1 < 0 || kor1 > 100) {
			System.out.println(kor1 + "은 유효하지 않아 종료");
			return;
		} else if(eng1 < 0 || eng1 > 100) {
			System.out.println(eng1 + "은 유효하지 않아 종료");
			return;
		} else if(math1 < 0 || math1 > 100) {
			System.out.println(math1 + "은 유효하지 않아 종료");
		}
		
		if(kor2 < 0 || kor2 > 100) {
			System.out.println(kor2 + "은 유효하지 않아 종료");
			return;
		} else if(eng2 < 0 || eng2 > 100) {
			System.out.println(eng2 + "은 유효하지 않아 종료");
			return;
		} else if(math2 < 0 || math2 > 100) {
			System.out.println(math2 + "은 유효하지 않아 종료");
		}
