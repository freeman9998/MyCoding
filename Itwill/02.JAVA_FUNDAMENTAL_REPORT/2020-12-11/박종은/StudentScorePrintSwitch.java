...
public class StudentScorePrintSwitch {
	...
	public static void main(String[] args) {
		 ...
		 */
		int no1, kor1, eng1, math1, tot1, ran1;
		int no2, kor2, eng2, math2, tot2, ran2;
		String name1, name2;
		char sco1, sco2;
		double avg1, avg2;
		 ...
		 */
		no1 = 1; name1 = "김경호"; kor1 = 42; eng1 = 56; math1 = 78;
		no2 = 2; name2 = "김경수"; kor2 = 45; eng2 = 53; math2 = 76;
		 ...
		 */
		if(kor1 < 0 || kor1 > 100) {
			System.out.println(name1 + " 학생의 국어점수를 다시 확인해주세요.");
			return;
		}else if(eng1 < 0 || eng1 > 100) {
			System.out.println(name1 + " 학생의 영어점수를 다시 확인해주세요. ");
			return;
		}else if(math1 < 0 || math1 > 100) {
			System.out.println(name1 + " 학생의 수학 점수를 다시 확인해주세요.");
			return;
		}
		
		if(kor2 < 0 || kor2 > 100) {
			System.out.println(name2 + " 학생의 국어점수를 다시 확인해주세요.");
			return;
		}else if(eng2 < 0 || eng2 > 100) {
			System.out.println(name2 + " 학생의 영어점수를 다시 확인해주세요. ");
			return;
		...
		*/
		...
		System.out.println("----------------------------------------------------------------");
		System.out.printf("%3d %5s %3d %5d %5d %6d %6.1f %4c %4d\n",no1, name1, kor1, eng1, math1, tot1, avg1, sco1, ran1);
		System.out.printf("%3d %5s %3d %5d %5d %6d %6.1f %4c %4d\n",no2, name2, kor2, eng2, math2, tot2, avg2, sco2, ran2);
