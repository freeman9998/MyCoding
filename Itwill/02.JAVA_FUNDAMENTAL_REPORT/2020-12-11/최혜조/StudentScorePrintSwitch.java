...
public class StudentScorePrintSwitch {
	...
	public static void main(String[] args) {
		...
		int no1, kor1, eng1, math1, tot1, no2, kor2, eng2, math2, tot2, rank ;
		double avg1, avg2;
		String name1, name2;
		...
		if (!(0<=kor1&&kor1<=100)) 
		{
			System.out.printf("%s님 %s점수는 0~100사이의 정수여야 합니다.\n",name1,"국어");
			return;	
		} 
		if (!(0<=eng1&&eng1<=100))
		{
		...
		*/
		...
		System.out.println("-----------------------------------------------");
		System.out.printf("%3d %4s %4d %4d %4d %4d %5.1f %3c %4d\n",no1,name1,kor1,eng1,math1,tot1,avg1,grade1,rank);
		System.out.printf("%3d %4s %4d %4d %4d %4d %5.1f %3c %4d\n",no2,name2,kor2,eng2,math2,tot2,avg2,grade2,rank);
		System.out.println("-----------------------------------------------"); 
