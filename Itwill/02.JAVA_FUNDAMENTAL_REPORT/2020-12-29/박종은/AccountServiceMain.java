...
public class AccountServiceMain {
	...
	public static void main(String[] args) {
		...
		Account num = new Account(2222, "박종은", 99999, 5.5);
		accountService.updateAccount(num);
		System.out.println("13.AccountService야 번호,이름,잔고,이율 계좌데이타줄께 이름,잔고,이율 수정(update)해줘");
		accountService.updateAccount(1111, "TEST", 1000000, 1.1);
	}
