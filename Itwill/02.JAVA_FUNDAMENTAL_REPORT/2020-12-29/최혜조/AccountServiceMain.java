...
public class AccountServiceMain {
	...
	public static void main(String[] args) {
		...
		accountService.addAccount(newacc1);
		accountService.addAccount(4567, "GARIN", 90000, 5.3);
		...
		accountService.ipGum(2222,500);
		System.out.println("9.AccountService야 계좌번호,출금할돈 인자로줄께 출금해줘");
		accountService.chulGum(5555,8000);
