...
public class AccountServiceMain {
	...
	public static void main(String[] args) {
		...
		Account addac1= new Account(7865,"MZW",99999,9.9);
		Account updateac1 = new Account(1111, "LEE", 50000, 2.5);
		
		System.out.println("0.Account추가(번호중복체크,배열사이즈증가)");
		accountService.addAccount(addac1);
		accountService.addAccount(8575, "TLM", 39800, 3.8);
		...
		accountService.chulGum(1111, 20000);
		...
		accountService.updateAccount(updateac1);
		System.out.println("13.AccountService야 번호,이름,잔고,이율 계좌데이타줄께 이름,잔고,이율 수정(update)해줘");
		accountService.updateAccount(2222, "BAK", 44444, 4.4);
	}
