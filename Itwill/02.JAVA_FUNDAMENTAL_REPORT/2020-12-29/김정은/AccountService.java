...
public class AccountService {
	...
	*/ 
	 ...
	 */ 
	public void ipGum(int no,int ipgum) {
		for (int i = 0; i < accounts.length; i++) {
			if (accounts[i].getNo()==no) {
				accounts[i].deposit(ipgum);
				accounts[i].print();
				break;
			}
		}
	 ...
	 */ 
	public void chulGum(int no,int chulgum) {
		for (int i = 0; i < accounts.length; i++) {
			if (accounts[i].getNo()==no) {
				accounts[i].withdraw(chulgum);
				accounts[i].print();
				break;
			}
		}
	...
	public void updateAccount(Account updateAccount) {
		for (int i = 0; i < accounts.length; i++) {
			if (updateAccount.getNo() == accounts[i].getNo()) {
				accounts[i].setAccountData(updateAccount.getNo(), updateAccount.getOwner(), updateAccount.getBalance(),
