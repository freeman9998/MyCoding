...
public class AccountService {
	...
	*/
	public void updateAccount1(Account updateAccount1) {
		for (int i = 0; i < accounts.length; i++) {
			if (accounts[i].getNo()==updateAccount1.getNo()) {
				accounts[i].setOwner(updateAccount1.getOwner());
				accounts[i].setBalance(updateAccount1.getBalance());
				accounts[i].setIyul(updateAccount1.getIyul());
				break;
			}
		}
