...
public class PrimitiveTypeArrayStudentMain {
	...
	public static void main(String[] args) {
		...
		int[] kora = {34, 56, 97, 89, 91, 67, 88, 93, 67, 99};
		//int[] enga = {44, 57, 96, 83, 93, 76, 81, 67, 12, 39};
		int[] enga = new int[]{44, 57, 96, 83, 93, 76, 81, 67, 12, 39};
		int[] matha = {90, 56, 99, 67, 23, 88, 99, 78, 55, 80};
	...
	//  2번 석차계산
		...
		*/
		...
		/*
		 *  3번학생 찾아서 1명 정보 출력 (학생번호는 중복되지 않는다.)
		 */
		System.out.println(">>3번학생 찾아서 1명 정보 출력");
		for (int i = 0; i < noArray.length; i++) {
			if(noArray[i] == 3) {
