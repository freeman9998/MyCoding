...
public class StudentServiceMain {
	...
	public static void main(String[] args) {
		 ...
		 * 3. 전체학생반환
		 */
		Student[] allStudent = studentService.getArrayStudent();
		/*
		 * 3. 전체학생출력
		 */
		...
		Student stu=studentService.findByNo(3);

		/*
		 * 5. 학점A인 학생들 반환
		 */
		System.out.println("5. 학점A인 학생들 반환");
		Student[] stuGrade = studentService.findByGrade('A');
		
		/*
		 * 5. 이름KIM 인 학생들 반환
		 */
		System.out.println("5.  이름KIM 인 학생들 반환");
		Student[] stuName= studentService.findByName("KIM");
