...
public class AccountServiceReturnMain {
	...
	public static void main(String[] args) {
		...
		accountServiceReturn.addAccount(new Account(1234, "JOY", 50000, 5.0));
