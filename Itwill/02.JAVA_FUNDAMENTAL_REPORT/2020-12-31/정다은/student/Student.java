...
public class Student {
	public static final int GRADE_A = 90;
	public static final int GRADE_B = 80;
	public static final int GRADE_C = 70;
	public static final int GRADE_D = 60;
	...
	*/
	...
	public char calculateGrade() {
		if(this.avg >= GRADE_A) {
			this.grade = 'A';
		}else if(this.avg >= GRADE_B) {
			this.grade = 'B';
		}else if(this.avg >= GRADE_C) {
			this.grade = 'C';
		}else if(this.avg >= GRADE_D) {
			this.grade = 'D';
		}else {
			this.grade = 'F';
		}
