...
public class StudentServiceMain {
	...
	public static void main(String[] args) {
		...
		Student stuno = studentService.findByNo(1);
		
		/*
		 * 5. 학점A인 학생들 반환
		 */
		System.out.println("5. 학점A인 학생들 반환");
		Student[] stu = studentService.findByGrade('A');
		
		/*
		 * 5. 이름KIM 인 학생들 반환
		 */
		System.out.println("6.이름KIM 인 학생들 반환");
		Student[] stu1 = studentService.findbyName("XIM");	
		/*
		 * 6. 학생석차로 오름차순정렬
		 */
		System.out.println("7. 학생석차로 오름차순정렬");
		studentService.studentSotrAsc();
