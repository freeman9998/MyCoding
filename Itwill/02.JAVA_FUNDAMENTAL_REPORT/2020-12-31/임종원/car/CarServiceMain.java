...
public class CarServiceMain {
	public static void main(String[] args) {
		CarService carService = new CarService(6);
		...
		carService.ipChar(new Car("7891", 2));
