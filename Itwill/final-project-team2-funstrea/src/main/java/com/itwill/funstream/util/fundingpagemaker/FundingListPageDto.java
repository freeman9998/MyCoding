...
public class FundingListPageDto {
	private List<FundingList> list; 		// 리스트 데이터 콜렉션
	...
	private int endRowNum;			//게시물 끝번호

	public FundingListPageDto() {
	}

	public FundingListPageDto(List<FundingList> list, int startPageNo, int endPageNo,
	...
	public List<FundingList> getList() {
		return list;
	}

	public void setList(List<FundingList> list) {
		this.list = list;
	}
