...
SELECT NAME,TO_CHAR(BIRTHDAY,'MMDD') FROM STUDENT WHERE DEPTNO1='101';

SELECT NAME,TO_CHAR(BIRTHDAY,'MM')||'월'||TO_CHAR(BIRTHDAY,' DD')||'일' "BIRTHDAY" 
FROM STUDENT 
WHERE DEPTNO1='101';
...
SELECT NAME,TEL,REPLACE(TEL,SUBSTR(TEL,INSTR(TEL,'-',1,1)),'-****') FROM STUDENT WHERE DEPTNO1='101';
