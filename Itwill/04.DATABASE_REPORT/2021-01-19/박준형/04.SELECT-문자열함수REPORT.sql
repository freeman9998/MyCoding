...
*/
SELECT NAME,TO_CHAR(birthday,'MMDD') as Birthday FROM student where deptno1=101;
SELECT NAME,TO_CHAR(birthday,'MM"월" DD"일"') as Birthday FROM student where deptno1=101;
/*
SELECT NAME,
EXTRACT(MONTH FROM birthday)||'월 '||EXTRACT(DAY FROM birthday)||'일' 
as Birthday FROM student where deptno1=101;
*/
/*
...
Anthony Hopkins	 7802232116784	780223-*******
*/
SELECT NAME,jumin,REPLACE(JUMIN,SUBSTR(JUMIN,7),'*******') AS "REPLACE" FROM student where deptno1=101;
SELECT NAME,jumin,REPLACE(JUMIN,SUBSTR(JUMIN,7),'-*******')AS "REPLACE" FROM student where deptno1=101;
...
*/
SELECT NAME,tel,
REPLACE(TEL,SUBSTR(tel,INSTR(TEL,'-')),'-****') as "REPLACE" 
